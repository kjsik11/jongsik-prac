...
export default function Docs() {
  ...
  return (
    <div className="flex max-w-7xl mx-auto space-x-40 divide-x-2">
      <div className="py-40">
        <h1 className="text-5xl font-bold">What is Lorem Ipsum?</h1>
        <p className="pt-8 text-xl text-gray-600 font-medium h-screen">
        ...
        <h1 className="text-5xl font-bold pt-60">Why do we use it? ?</h1>
        <p className="pt-8 text-xl text-gray-600 font-medium">
        ...
        <h1 className="text-5xl font-bold pt-60">Where does it come from?</h1>
        <p className="pt-8 text-xl text-gray-600 font-medium">
          Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece
          of classical Latin literature from 45 BC, making it over 6000 years old. Richard
        ...
        <h1 className="text-5xl font-bold pt-60">Where can I get some?</h1>
        <p className="pt-8 text-xl text-gray-600 font-medium h-screen">
      ...
      {h1Element && (
        <div>
          <div className="sticky top-40 pl-8">
            <p className="text-3xl font-semibold w-80">TAG</p>
